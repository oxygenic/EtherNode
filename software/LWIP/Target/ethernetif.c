...
static void low_level_init(struct netif *netif)
{
  ...
  const int32_t uid=HAL_GetUIDw0()^HAL_GetUIDw1()^HAL_GetUIDw2();
  MACAddr[3] = ((uid & 0xFF000000) >> 24)^((uid % 0x00FF0000) >> 16);
  MACAddr[4] = ((uid & 0x0000FF00)>>8);
  MACAddr[5] = (uid & 0x000000FF);
